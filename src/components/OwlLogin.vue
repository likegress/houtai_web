...
<!-- <template>
  <div
    :class="'owl-login' 'eyes' 'arm-up-right' 'arm-up-left' 'arm-down-right' { password }"
  ></div> -->
</template>
<script>
export default {
...
.owl-login
  ...
  .arm-down-left
    ...
    width: 43px
    height: 25px
    background-image: url(~@/assets/img/arm-down-left.png)
  ...
  .arm-down-right
    ...
    width: 43px
    height: 26px
    background-image: url(~@/assets/img/arm-down-right.png)
    transition: .3s ease-out
  .arm-up-left, .arm-up-right
    bottom: 11px
    width: 51px
    height: 41px
  ...
  .arm-up-left
    left: -3px
    background-image: url(~@/assets/img/arm-up-left.png)
    transform: translateX(-34px) scale(.8)
  .arm-up-right
    right: 5px
    background-image: url(~@/assets/img/arm-up-right.png)
